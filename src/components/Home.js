                ...
                <div className='container mx-auto'>
                    ...
                    <div className="flex flex-col justify-center text-center items-center gap-x-12 py-12">
                        ...
                        <div data-aos="fade-left" className="lg:w-1/2 w-full md:mt-0 mt-12">
                            ...
                            <h2 className='md:text-4xl text-3xl font-cehua font-semibold text-white-100'>
                                Fast, Simple & Secure
                            </h2>
                    ...
                    <div className="lg:flex block justify-between items-baseline gap-x-12 py-12 lg:w-9/12 mx-auto border-2 border-yellow-50 lg:p-8 p-5 space-y-6">
                        ...
                        <div className=''>
                            ...
                            <div className='flex items-center gap-x-8 mt-6 space-y-4 flex-wrap'>
                                <img src={list_1} alt='token' className='flex mx-auto lg:w-full w-1/4'></img>
                                <img src={list_2} alt='token' className='flex mx-auto lg:w-full w-1/4'></img>
                                <img src={list_3} alt='token' className='flex mx-auto lg:w-full w-1/4'></img>
                            </div>
                        </div>
